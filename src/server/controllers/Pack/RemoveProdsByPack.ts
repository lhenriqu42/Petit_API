...
import { IRequestBody } from '../../database/providers/Packs/removeProdsByPack';
...
export const removeProdsByPackValidation = validation({
    body: bodyValidation,
    params: paramValidation
});

export const removeProdsByPack: RequestHandler = async (req: Request<IParamProps, {}, IBodyProps>, res: Response) => {
    ...
    const result = await PackProvider.removeProdsByPack({ prods: req.body.prods, pack_id: req.params.packId });
