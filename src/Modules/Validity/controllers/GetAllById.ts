...
export const getAllById: RequestHandler = async (req: Request<IParamProps, {}, {}, IQueryProps>, res: Response) => {
    ...
    const result = await ValidityProvider.getAllById(req.query.page || DEFAULT_PAGE, req.query.limit || DEFAULT_LIMIT, req.params.id);
    const count = await ValidityProvider.countById(req.params.id);
